...
from ..models import Model_ConfigBenefit, Model_ConfigBenefitProductVariation, \
    Model_ConfigBenefitDuration, Model_ConfigBenefitDurationItem, Model_ConfigBenefitProvision
from ..schemas import Schema_ConfigBenefit, Schema_ConfigBenefitDuration, \
    Schema_ConfigBenefitDurationItem, Schema_ConfigBenefitProductVariation, \
...
config_benefit_duration_items_schema = Schema_ConfigBenefitDurationItem()
config_benefit_product_variation_schema = Schema_ConfigBenefitProductVariation()
config_benefit_provision_schema = Schema_ConfigBenefitProvision()
...
config_benefit_provision_schema_list = Schema_ConfigBenefitProvision(many=True)
...
class CRUD_BenefitDurationItemsConfig(Resource):
    ...
    @classmethod
    def get(cls, id):
        config = Model_ConfigBenefitDurationItem.find(id)
...
class CRUD_BenefitProvisionConfig(Resource):
    ...
    def post(cls):
        ...
        Model_ConfigBenefitProvision.save_all_to_db(config)
    ...
    def delete(cls):
        ...
        config = Model_ConfigBenefitProvision.find(benefit_id, provision_id)
        config.delete()
        return "Deleted", 204
