TBL_NAMES = {
    ...
    "CONFIG_BENEFIT_STATE_AVAILABILITY": "config_benefit_state_availabiity",
    "CONFIG_COVERAGE": "config_coverage",
    "CONFIG_COVERAGE_STATE_AVAILABILITY": "config_coverage_state_availabiity",
    "CONFIG_FACTOR": "config_factor",
    "CONFIG_FACTOR_RULE": "config_factor_rule",
    "CONFIG_PRODUCT": "config_product",
    "CONFIG_PRODUCT_STATE_AVAILABILITY": "config_product_state_availabiity",
    "CONFIG_PRODUCT_VARIATIONS": "config_product_variations",
    "CONFIG_PROVISION": "config_provision",
    "CONFIG_PROVISION_STATE_AVAILABILITY": "config_provision_state_availabiity",
